...
int main(int argc, char * argv[])
{
  ...
  auto handeye = yaml["handeye_test"];
  auto height = handeye["height"].IsDefined() ? handeye["height"].as<double>() : 0.6;
  auto grid_num = handeye["grid_num"].IsDefined() ? handeye["grid_num"].as<int>() : 6;
  auto grid_size = handeye["grid_size"].IsDefined() ? handeye["grid_size"].as<double>() : 0.1;
  auto delay = handeye["delay"].IsDefined() ? handeye["delay"].as<int>() : 0;
